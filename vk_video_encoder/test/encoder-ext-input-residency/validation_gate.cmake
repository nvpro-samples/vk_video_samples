...
if(DEFINED TEST_ARGS AND NOT TEST_ARGS STREQUAL "")
  # Accept the list spelling too. A caller that passes ${ARGN} straight
  # through hands us "--arm;--validate", which has no whitespace, so
  # separate_arguments would return it unsplit as ONE argument -- and an
  # unrecognised argument makes the subject print usage and exit non-zero,
  # which reads as a test failure rather than as a harness bug. Normalising
  # first means both spellings work and neither fails silently.
