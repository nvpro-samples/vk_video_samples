...
public:
                                         ...
                                         const VkImageResourceView* outputImageView)
    {
        ...
        if (m_descriptorSetLayout.GetDescriptorSetLayoutInfo().GetDescriptorLayoutMode() ==
            ...
            if (m_inputImageAspects & VK_IMAGE_ASPECT_COLOR_BIT) {
                ...
                writeDescriptorSets[descrIndex].dstSet = 0;
            ...
            m_vkDevCtx->CmdPushDescriptorSetKHR(cmdBuf, VK_PIPELINE_BIND_POINT_COMPUTE,
                                                ...
                                                0, descrIndex, writeDescriptorSets.data());
        } else {
...
private:
    VkResult InitDescriptorSetLayout();
