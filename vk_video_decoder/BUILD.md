...
Windows 10 with the following software packages:
...
- [FFMPEG libraries for Windows]
    ...
    https://github.com/BtbN/FFmpeg-Builds/releases/download/autobuild-2020-11-18-12-33/ffmpeg-N-99931-ge3081d6f4f-win64-gpl-shared-vulkan.zip
    Then extract the archive to <APP_INSTALLED_LOC>\bin\libs\ffmpeg and add the path of the <APP_INSTALLED_LOC>\bin\libs\ffmpeg\win64\bin to
    the system's path. Please make sure that <APP_INSTALLED_LOC>\bin\libs\ffmpeg\win64\bin location contains
    avformat-58.dll, avutil-56.dll and avcodec-58.dll shared libraries.
...
To run the Vulkan Video Decode sample (from the build dir):
